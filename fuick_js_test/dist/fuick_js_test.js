...
(() => {
    ...
    "node_modules/react-reconciler/cjs/react-reconciler.development.js"(exports, module) {
      ...
      if (true) {
        module.exports = function $$$reconciler($$$hostConfig) {
          var exports2 = {};
          "use strict";
          var React4 = require_react_development();
  ...
  var require_router = __commonJS({
    "../fuick_js_framework/dist/router.js"(exports) {
      ...
      exports.match = match;
      var Navigator = __importStar(require_navigator());
      var routes = {};
  ...
  var require_runtime = __commonJS({
    "../fuick_js_framework/dist/runtime.js"(exports) {
      ...
      function bindGlobals() {
        ...
        globalThis.ReactRouter = Router2.Router;
      }
      exports.Runtime = {
        bindGlobals
      };
  ...
  var TestPage1 = () => {
    return /* @__PURE__ */ import_react.default.createElement(import_fuick_js_framework.Container, { color: "#f0f2f5" }, /* @__PURE__ */ import_react.default.createElement(import_fuick_js_framework.Center, null, /* @__PURE__ */ import_react.default.createElement(import_fuick_js_framework.Column, { crossAxisAlignment: "center" }, /* @__PURE__ */ import_react.default.createElement(import_fuick_js_framework.Text, { text: "Test Page 1", fontSize: 24, color: "#1a1a1a" }), /* @__PURE__ */ import_react.default.createElement(import_fuick_js_framework.Text, { text: "This is a page from the new test project.", fontSize: 16, color: "#666666", padding: { top: 10, bottom: 20 } }), /* @__PURE__ */ import_react.default.createElement(import_fuick_js_framework.Button, { text: "Click Me", onTap: () => ReactRouter.push("/test2") }))));
  };
